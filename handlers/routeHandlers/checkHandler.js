 ...
 * Description: Hanlder to handle user definded chcek
   ...
   requestProperties.body.url.trim().length>0 ? requestProperties.body.url
    ...
    && requestProperties.body.timeoutSeconds<=5 ? requestProperties.body.timeoutSeconds : false;
      ...
      if(protocol && url,method && successCodes && timeoutSeconds)
      {
                            ...
                            tokenHandler._token.verify(token,userPhone,(tokenValid)=>
                            {
                                if(tokenValid)
                                {
                                    ...
                                    if(userChecks.length<maxChecks)
                                    {
                                        ...
                                        callback(403,{
                                            error: 'user has already cross max checks limit'
                                        })
        ...
        callback(400,{
            error : 'Your a problem in your request'
        })
      }
            ...
            if(protocol || url || method || successCodes || timeoutSeconds)
            {
                ...
                data.read('checks',id,(err1,checkData)=>
                {
                    ...
                    if(!err1 && checkData)
                    {
                        ...
                        {
                            console.log('tokenvalid',tokenIsValid);
                        ...
                        data.delete('checks',id,(err2)=>
                        {
                            if(!err2)
                            {
                                ...
                                callback(500,{
                                    ...
                                    error:'Your are a server side error'
